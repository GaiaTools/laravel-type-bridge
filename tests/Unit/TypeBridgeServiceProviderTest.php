...
class TypeBridgeServiceProviderTest extends TestCase
{
    ...
    public function register_binds_default_i18next_adapter(): void
    {
        ...
        $this->app['config']->set('type-bridge.translations.i18n_library', 'i18next');
    ...
    {
        $this->app['config']->set('type-bridge.translations.i18n_library', 'vue-i18n');
        $this->app['config']->set('type-bridge.translations.custom_adapter', null);
    ...
    {
        $this->app['config']->set('type-bridge.translations.i18n_library', 'laravel');
        $this->app['config']->set('type-bridge.translations.custom_adapter', null);
    ...
    {
        $this->app['config']->set('type-bridge.translations.i18n_library', 'unknown-lib');
        $this->app['config']->set('type-bridge.translations.custom_adapter', null);
