...
final class I18nextSyntaxAdapterTest extends TestCase
{
    private I18nextSyntaxAdapter $adapter;

    protected function setUp(): void
    {
        parent::setUp();
        $this->adapter = new I18nextSyntaxAdapter;
    }

    #[Test]
    public function it_returns_correct_target_library(): void
    {
        $this->assertSame('i18next', $this->adapter->getTargetLibrary());
    }
    ...
    public function it_transforms_complex_pluralization_with_zero(): void
    {
        ...
        $expected = [
            'apples_zero' => 'There are none',
            'apples_one' => 'There is one',
            'apples_other' => 'There are {{count}}',
        ];
    ...
    public function it_handles_mixed_content_in_arrays(): void
    {
        ...
        $expected = [
            ...
            'plural_one' => 'item',
            'plural_other' => 'items',
            'complex_plural_zero' => 'None',
            'complex_plural_one' => 'One',
            'complex_plural_other' => '{{count}}',
        ];
